function RNN_main_test(time_block)

S = sprintf('./network/RNN_net_timeblock_%d', time_block);
load(S);

SS = sprintf('RNN_test_data_timeblock_%d.mat', time_block);
load(SS);
...
SSS = sprintf('./performance/RNN_performance_timeblock=%d', time_block);
