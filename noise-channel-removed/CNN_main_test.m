function CNN_main_test(time_block)

S = sprintf('./network/CNN_net_timeblock_%d', time_block);
load(S);

SS = sprintf('CNN_test_data_timeblock_%d.mat', time_block);
load(SS);
...
SSS = sprintf('./performance/CNN_performance_timeblock=%d', time_block);
