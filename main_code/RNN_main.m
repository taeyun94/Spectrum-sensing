...
load RNN_training_data_set_AWGN_fft512_64  % trainig set load
...
clear XTrain YTrain;
save RNN_network_timeblock_64 net;

%% TEST
load RNN_test_data_set_AWGN_fft512_64  % test set load
...
SNR = -20:2:6;
save RNN_performance_64block MDR FDR ACC SNR
