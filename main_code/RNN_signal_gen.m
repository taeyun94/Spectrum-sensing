...
XTrain_matrix = XTrain(:,:,1,rand_idx); % shuffle
...
S = sprintf('RNN_training_data_set_AWGN_fft512_%d.mat', N_time_block);
...
XTest_matrix = zeros(2*width,N_time_block,1,N_test*N_ch,length(SNR_table)); % matrix, used for RNN
...
S = sprintf('RNN_test_data_set_AWGN_fft512_%d.mat', N_time_block);
