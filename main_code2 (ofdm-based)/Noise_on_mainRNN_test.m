function Noise_on_RNN_test(time_block)

S = sprintf('./network/Noise_on_RNN_net_timeblock_%d', time_block);
load(S);

SS = sprintf('Noise_on_test_data_OFDM_rnn_timeblock_%d.mat', time_block);
load(SS);
...
SSS = sprintf('./performance/Noise_on_RNN_timeblock_%d_2', time_block);
