function Noise_off_mainCNN_test(time_block)

S = sprintf('./network/Noise_off_CNN_net_timeblock_%d', time_block);
load(S);

SS = sprintf('Noise_off_test_data_OFDM_cnn_timeblock_%d.mat', time_block);
load(SS);
...
SSS = sprintf('./performance/Noise_off_CNN_timeblock_%d', time_block);
